...
public class DashboardResponse {
    ...
    public List<LoanApplicationResponse> getRecentLoans() {
        return recentLoans;
    }

    public void setRecentLoans(List<LoanApplicationResponse> recentLoans) {
        this.recentLoans = recentLoans;
    }

    public CustomerProfileSummary getCustomerProfile() {
        return customerProfile;
    }

    public void setCustomerProfile(CustomerProfileSummary customerProfile) {
